        ...
        <div id="copilotBuiltinMode" class="copilot-mode-content active">
            ...
            <div class="copilot-input-area">
                ...
                <div class="copilot-quick-actions">
                    ...
                    <button onclick="copilotQuickAction('financieel')"><svg xmlns="http://www.w3.org/2000/svg" class="lucide-icon" aria-hidden="true" width="1em" height="1em" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M4 10h12"/><path d="M4 14h9"/><path d="M19 6a7.7 7.7 0 0 0-5.2-2A7.9 7.9 0 0 0 6 12c0 4.4 3.5 8 7.8 8 2 0 3.8-.8 5.2-2"/></svg> Financieel</button>
                </div>
            </div>
        </div>
...
async function callAzureOpenAI(message, file) {
	...
	if (!config || !config.endpoint || !config.apiKey) {
		throw new Error(
			"Azure OpenAI not configured. Configure a proxy URL or direct endpoint in Admin > AI.",
		);
	}
	...
	console.warn(
		"[Security] Azure OpenAI API key is stored client-side. Configure a proxyUrl in Admin > AI for production.",
	);
	...
	try {
		...
		return `<p>Ik begrijp uw vraag. Hier zijn enkele opties:</p>
            <ul>
                ...
                <li><svg xmlns="http://www.w3.org/2000/svg" class="lucide-icon" aria-hidden="true" width="1em" height="1em" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M4 10h12"/><path d="M4 14h9"/><path d="M19 6a7.7 7.7 0 0 0-5.2-2A7.9 7.9 0 0 0 6 12c0 4.4 3.5 8 7.8 8 2 0 3.8-.8 5.2-2"/></svg> Vraag naar <strong>financieel overzicht</strong></li>
...
function generateOverviewResponse(
	...
	const inkomsten = yearTransacties
		...
		.reduce((s, t) => s + Number.parseFloat(t.bedrag || 0), 0);
	...
	return `<p><strong><svg xmlns="http://www.w3.org/2000/svg" class="lucide-icon" aria-hidden="true" width="1em" height="1em" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"><rect width="7" height="9" x="3" y="3" rx="1"></rect><rect width="7" height="5" x="14" y="3" rx="1"></rect><rect width="7" height="9" x="14" y="12" rx="1"></rect><rect width="7" height="5" x="3" y="16" rx="1"></rect></svg> Portefeuille Overzicht</strong></p>
        <table style="width:100%;font-size:13px;border-collapse:collapse;">
            ...
            <tr><td style="padding:4px 8px;"><svg xmlns="http://www.w3.org/2000/svg" class="lucide-icon" aria-hidden="true" width="1em" height="1em" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M4 10h12"/><path d="M4 14h9"/><path d="M19 6a7.7 7.7 0 0 0-5.2-2A7.9 7.9 0 0 0 6 12c0 4.4 3.5 8 7.8 8 2 0 3.8-.8 5.2-2"/></svg> Maandelijkse huur</td><td style="padding:4px;font-weight:bold;">€${maandHuur.toLocaleString("nl-NL")}</td></tr>
...
function generateFinancialResponse(transacties, contracten) {
	...
	const monthlyRent = activeContracts.reduce(
		(s, c) => s + Number.parseFloat(c.huurprijs || 0),
		0,
	);

	return `<p><strong><svg xmlns="http://www.w3.org/2000/svg" class="lucide-icon" aria-hidden="true" width="1em" height="1em" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M4 10h12"/><path d="M4 14h9"/><path d="M19 6a7.7 7.7 0 0 0-5.2-2A7.9 7.9 0 0 0 6 12c0 4.4 3.5 8 7.8 8 2 0 3.8-.8 5.2-2"/></svg> Financieel Overzicht ${year}</strong></p>
        <table style="width:100%;font-size:13px;border-collapse:collapse;">
...
function generatePropertyResponse(panden) {
	...
	if (byStatus.beschikbaar && byStatus.beschikbaar.length > 0) {
		...
		byStatus.beschikbaar.forEach((p) => {
			html += `<li>${s(p.adres)}, ${s(p.plaats)} - €${Number.parseFloat(p.huurprijs).toLocaleString("nl-NL")}/mnd</li>`;
		});
		html += "</ul>";
	}
...
function generateEmailHelpResponse(message) {
	return `<p><strong><svg xmlns="http://www.w3.org/2000/svg" class="lucide-icon" aria-hidden="true" width="1em" height="1em" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg> Email Hulp</strong></p>
        ...
        <ul>
            ...
            <li><svg xmlns="http://www.w3.org/2000/svg" class="lucide-icon" aria-hidden="true" width="1em" height="1em" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M4 10h12"/><path d="M4 14h9"/><path d="M19 6a7.7 7.7 0 0 0-5.2-2A7.9 7.9 0 0 0 6 12c0 4.4 3.5 8 7.8 8 2 0 3.8-.8 5.2-2"/></svg> <strong>Huurverhoging</strong> - Beschikbaar via de email templates</li>
        </ul>
...
function generateHelpResponse() {
	...
	return `<p><strong><svg xmlns="http://www.w3.org/2000/svg" class="lucide-icon" aria-hidden="true" width="1em" height="1em" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M12 7v14"/><path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"/></svg> Hoe werkt deze applicatie?</strong></p>
        ...
        <ul>
            ...
            <li><svg xmlns="http://www.w3.org/2000/svg" class="lucide-icon" aria-hidden="true" width="1em" height="1em" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M4 10h12"/><path d="M4 14h9"/><path d="M19 6a7.7 7.7 0 0 0-5.2-2A7.9 7.9 0 0 0 6 12c0 4.4 3.5 8 7.8 8 2 0 3.8-.8 5.2-2"/></svg> <strong><a href="financieel.html" style="color:var(--primary-color);">Financieel</a></strong> - Inkomsten, uitgaven en rapportages</li>
        </ul>
