...
function exportToCSV(data, filename, columns) {
    ...
    if (typeof logAuditEvent === 'function') {
        logAuditEvent('export', filename, null, { description: `${data.length} rijen geëxporteerd als CSV` });
    }
}
...
async function exportContractenCSV() {
    ...
    exportToCSV(contracten, 'contracten', [
        ...
        { key: 'pandId', label: 'Pand', formatter: (c) => {
...
async function exportOnderhoudCSV() {
    ...
    exportToCSV(onderhoud, 'onderhoud', [
        { key: 'pandId', label: 'Pand', formatter: (m) => {
