  ...
  onderhoud: [
    {
      ...
      activiteitenLog: [
        { datum: new Date("2024-10-15T09:00:00").toISOString(), gebruiker: "Technisch beheer", actie: "aangemaakt", details: "Prioriteit: normaal" },
        { datum: new Date("2024-10-16T14:30:00").toISOString(), gebruiker: "Beheerder", actie: "bijgewerkt", details: "Status: nieuw → in-behandeling" },
        { datum: new Date("2024-10-18T10:15:00").toISOString(), gebruiker: "Beheerder", actie: "bijgewerkt", details: "Status: in-behandeling → gepland; Uitvoerder: Warmtebeheer Amsterdam" },
      ],
