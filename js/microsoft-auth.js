...
function getMicrosoftMsalConfig() {
	...
	if (!clientId || !tenantId) {
		throw new Error(
			"Microsoft 365 is nog niet geconfigureerd. Vul Client ID en Tenant ID in via Admin > Azure AD.",
		);
	}
...
function initializeMSAL() {
	msalInstance = new msal.PublicClientApplication(getMicrosoftMsalConfig());
	return msalInstance;
}
