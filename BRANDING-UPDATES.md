...
```css
@keyframes pulseDemo {
    0%, 100% { box-shadow: 0 4px 12px rgba(198, 156, 109, 0.3); }
    50% { box-shadow: 0 6px 20px rgba(198, 156, 109, 0.5); }
}
```
...
### Hover States
```css
background: linear-gradient(135deg, rgba(30, 58, 95, 0.08) 0%, rgba(198, 156, 109, 0.12) 100%);
```
